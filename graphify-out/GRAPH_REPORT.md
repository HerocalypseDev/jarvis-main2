...
Cohesion: 0.06
Nodes (57): _bytes_to_gb(), _bytes_to_mb(), check_system_health(), _choose_input_device(), _chrome_executable(), _craft_system_status_summary(), _cursor_executable(), _cursor_foreground_hwnd_win32() (+49 more)
...
Cohesion: 0.05
Nodes (53): AbstractEventLoop, _autonomy_inbound(), _autonomy_mail_hook(), _autonomy_run_agent(), _background_tasks_dir(), mail(), _check_background_tasks(), _check_due_reminders() (+45 more)
...
Cohesion: 0.09
Nodes (23): _autonomy_calendar_events(), _autonomy_callbacks(), _autonomy_create_event(), calendar(), _calendar_events_raw(), _commands_in_flight(), create_reminder(), execute_mcp_tool() (+15 more)
...
### Community 31 - "Path"
Cohesion: 0.11
Nodes (23): _cleanup_old_logs(), _dashboard_get_services_status(), _fmt_gb(), get_large_files_report(), _load_mcp_server_configs(), _mcp_servers_config_path(), _memory_db_path(), _own_code_context_line() (+15 more)
...
### Community 34 - "main"
Cohesion: 0.06
Nodes (35): _acquire_single_instance_lock(), _away_warn(), block_samples(), _dashboard_get_sleep(), _dashboard_kill_background_task(), _face_greet(), _hold_modes(), _interrupt_speech() (+27 more)
...
### Community 45 - "_handle_text_command_impl"
Cohesion: 0.05
Nodes (40): _collapse_paths_for_speech(), _dashboard_approve_pending(), _sink(), _dashboard_reject_pending(), _execute_confirmed_action(), _face_release_held_notifications(), flush_pending_notifications(), _handle_text_command_impl() (+32 more)
...
Cohesion: 0.13
Nodes (26): api_audit(), api_briefing(), api_clear_finished_sessions(), api_recent_commands(), api_state(), _build_state(), clear_finished_sessions(), _connect() (+18 more)
...
Cohesion: 0.24
Nodes (17): disable(), enable(), kind='nap' runs the exact same mode (quiet notifications, mail take-over, dark…, _set_state(), set_system_action_handler(), _set_volume(), toggle(), _fake_env() (+9 more)
...
Cohesion: 0.21
Nodes (17): _connect(), _get_state(), Connection, Read-only sleep trends for the dashboard, from sleep_log alone (no new tables).…, save_digest(), set_wake_digest_handler(), stats_summary(), status() (+9 more)
...
Cohesion: 0.06
Nodes (46): _append_history(), _apply_memory_db_pragmas(), cancel_reminder(), _catastrophic_reason(), _count_running_background_tasks(), _create_memory_tables(), _current_command_source(), _dashboard_get_usage() (+38 more)
...
Cohesion: 0.21
Nodes (13): set_disabled(), _held(), Tests for jarvis_guest_reminders (the stranger -> "disable reminders?" Telegram…, test_default_group_safe_hold_still_lets_urgent_reminders_speak(), test_flush_on_any_command_does_not_leak_held_reminders(), test_pending_question_holds_reminders_but_does_not_text_them_yet(), test_reenabling_reads_out_the_held_reminders(), test_reminders_are_held_texted_and_silent_once_disabled() (+5 more)
...
### Community 123 - "jarvis_roblox.py"
Cohesion: 0.20
...
### Community 127 - "_briefing_fetchers"
Cohesion: 0.09
Nodes (21): _briefing_fetchers(), failed(), pending(), reminders(), briefing_report(), _dashboard_get_pending(), _deterministic_intent_reply(), _last_actions_reply() (+13 more)

### Community 128 - "jarvis_vibes.py"
Cohesion: 0.36
...
Cohesion: 0.06
Nodes (49): enabled(), JARVIS_<LAYER>_CACHE env flag, default on. Read on every call so it can be…, record(), stable_hash(), _cached_tools(), Tool definitions for the model, sorted so the tool prefix (and its prompt…, schemas(), ensure_mcp_started() (+41 more)

### Community 130 - "j"
Cohesion: 0.15
Nodes (12): configure(), holding_reminders(), True while due reminders must be held (not spoken, no toast)., reset(), j(), Phone, fixture, Stands in for Telegram: records what Jarvis texts, and can be made to fail. (+4 more)
...
### Community 133 - "jarvis_weather.py"
Cohesion: 0.50
...
- **Why does `_execute_tool_impl()` connect `_execute_tool_impl` to `jarvis_vibes.py`, `run_agent_loop`, `FileWatcher`, `jarvis.py`, `jarvis_weather.py`, `jarvis_memory_enhance.py`, `queue_or_deliver_notification`, `jarvis_guest_reminders.py`, `_claude_request`, `jarvis_dynamic_tools.py`, `jarvis_workflow.py`, `jarvis_proactive.py`, `jarvis_focus.py`, `_autonomy_callbacks`, `download_image`, `jarvis_autonomy_organise.py`, `Path`, `test_qol.py`, `test_restart.py`, `_handle_text_command_impl`, `test_hardening.py`, `jarvis_billing.py`, `jarvis_tech_understanding.py`, `_db`, `jarvis_face.py`, `jarvis_autonomy_skills.py`, `test_face.py`, `build_system_blocks`, `jarvis_autonomy.py`, `is_paused`, `enable`, `test_dev_features.py`, `stats_summary`, `jarvis_task_scheduler.py`, `_memory_db_connect`, `test_guest_reminders.py`, `jarvis_roblox.py`, `_briefing_fetchers`?**
...
- **Why does `_build_app()` connect `_build_app` to `start`, `test_dashboard_llm_endpoints`, `_ConnectionManager`, `_set_broadcast`, `_origin_is_loopback`, `api_command`, `jarvis_dashboard.py`?**
